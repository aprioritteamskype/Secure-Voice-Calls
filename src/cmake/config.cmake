...
if (MSVC)
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /W3 /MP /EHsc -DWIN32_LEAN_AND_MEAN -D_WIN32_WINNT=0x0602 -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX -DASIO_STANDALONE")
    ...
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -Werror -Wno-unknown-pragmas -DASIO_STANDALONE")
